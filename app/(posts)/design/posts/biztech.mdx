...
1. **Streamlined User Flow**: The app tied users of the application to membership - if a new user wanted to create an account and view events, they would instantly be redirected to purchase a membership if they didn’t have one. By preventing access without membership, there were many edge cases that generated unnecessary friction throughout the sign in progress.

2. **Responsive Layouts**: Each page on the application has a unique mobile layout that dynamically changes based on the browser window size. For mobile devices, this is typically a width of 480px - 600px. Users will now be able to have a consistent experience across devices.

3. **Improved Admin Experience**: By building out a view that allows admins to select attendees and perform functions based on selection, users no longer have to type out each attendee’s email manually in order to check them in - they can simply select their record from the table and click a couple of buttons.
...
<div className="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-4">
  ...
  <Image
    src="/assets/project-images/biztech/biztech-1.webp"
    alt="Image"
    width={300}
    height={300}
    className='block'
  />
    ...
    <Image
    src="/assets/project-images/biztech/biztech-2.webp"
    alt="Image"
    width={300}
    height={300}
    className='block'
  />
    <Image
    src="/assets/project-images/biztech/biztech-3.webp"
    alt="Image"
    width={300}
    height={300}
    className='block'
  />
    <Image
    src="/assets/project-images/biztech/biztech-4.webp"
    alt="Image"
    width={300}
    height={300}
    className='block'
  />
    <Image
    src="/assets/project-images/biztech/biztech-5.webp"
    alt="Image"
    width={300}
    height={300}
    className='block'
  />
    <Image
    src="/assets/project-images/biztech/biztech-6.webp"
    alt="Image"
    width={300}
    height={300}
    className='block'
  />
    <Image
    src="/assets/project-images/biztech/biztech-7.webp"
    alt="Image"
    width={300}
    height={300}
    className='block'
...
1. User interviews are so crucial to understanding the purpose of an app - **refrain from designing anything you've spoken 1:1 with long-time users**.
2. **Understand feedback instead of challenging it** - design is inherently subjective and your goal should be to have your designs accomodate your target user base (the people giving you feedback).
3. **Design systems and brand guidelines** make your life easier once you understand how to create effective ones. Building flexible & modular components that can adjust to different webpage states streamlines iterative design by a significant margin.