...
1. User interviews are so crucial to understanding the purpose of an app - **refrain from designing anything you've spoken with real people**.
2. **Understand feedback instead of challenging it** - design is inheretly subjective and your goal should be to have your designs accomodate everyone, not force everyone to accomodate to your design.
3. **Design systems and brand guidelines** make your life so much easier once you understand how to create effective ones.